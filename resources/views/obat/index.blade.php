        ...
        <div class="modal-body">
            <form method="post" action="{{route('dashboard-obat.store')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Plu" name="plu" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Satuan</label>
                  <select class="form-control" style="width: 100%;" name="satuan" >
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="{{route('dashboard-obat.update',$item->id )}}">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">PLU</label>
                    <input type="number" class="form-control" placeholder="Plu" value="{{$item->plu}}" name="plu" >
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Name</label>
                  <input type="text" class="form-control" placeholder="Name" value="{{$item->name}}" name="name" >
                </div>
                <div class="form-group">
                    <label>Category</label>
                    <select class="form-control" style="width: 100%;" name="category" >
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Stock</label>
                    <input type="number" class="form-control" placeholder="Stock" value="{{$item->stock}}" name="stock" >
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Price </label>
                    <input type="number" class="form-control" placeholder="Price" value="{{$item->price}}" name="price" >
                </div>
              </div>
              <!-- /.card-body -->
