              ...
              <div class="card-body col-md-12 form_content">
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control input" id="no_transaksi"  placeholder="No Transaksi" maxlength="10" required  name="no_transaksi" >
                      </div>
                  </div>
    ...
    <script type="text/javascript">
        ...
        function save(save){
          var checkrequired = $('input,textarea,select').filter('[required]:visible')
            ...
            urlsnya = '{{route('dashboard-transaction.store')}}';
